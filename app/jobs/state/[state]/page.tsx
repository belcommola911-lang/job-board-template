  ...
  try {
    ...
    return {
      ...
      alternates: {
        ...
        canonical: `${brand.baseUrl}/jobs/state/${stateToSlug(stateName)}`,
      },
    ...
    <div className="min-h-screen" style={{ backgroundColor: '#FDFBF7' }}>
      ...
      <div style={{ background: 'linear-gradient(180deg, #FFF8F0 0%, #FDFBF7 100%)', padding: '48px 0' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          ...
          <h2 className="font-lora" style={{ fontSize: 'clamp(26px, 3.5vw, 38px)', fontWeight: 700, color: '#1A2E35', textAlign: 'center', marginBottom: '8px' }}>Working as {indefinite(brand.niche.short)} in {stateName}</h2>
        ...
        <section style={{ maxWidth: '1200px', margin: '0 auto', padding: '56px 20px' }}>
          ...
          <div style={{ display: 'grid', gap: '12px' }}>
            {[
              ...
              { q: `Can I work remotely as ${indefinite(brand.niche.short)} in ${stateName}?`, a: `Yes, many telehealth and remote ${brand.niche.short} positions allow you to practice from ${stateName}. You'll need an active NP license in the state where your patient resides.` },
            ].map((faq, idx) => (
          ...
          <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
            ...
            { q: `Can I work remotely as ${indefinite(brand.niche.short)} in ${stateName}?`, a: `Yes, many telehealth positions are available.` },
