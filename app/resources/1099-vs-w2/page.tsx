  ...
  const compFaqs = [
    {
      ...
      answer: `It depends on your priorities. 1099 offers higher gross pay ($75-$150+/hr), schedule flexibility, and tax deductions but requires self-management of taxes, insurance, and retirement. W2 offers stability, employer benefits (health, 401k, PTO, malpractice), and simpler taxes. Most ${brand.niche.short}s who value income maximization prefer 1099 after gaining 2-3 years of experience.`
    },
    {
      question: `How much more do 1099 ${brand.niche.short}s make than W2?`,
      answer: `1099 ${brand.niche.short}s earn 20-40% higher GROSS hourly rates than W2 ($75-$150/hr vs $55-$100/hr). However, after accounting for self-employment tax (15.3%), individual health insurance ($6K-$18K/year), malpractice ($1.5-3K/year), and no employer 401k match, the NET take-home difference is typically 10-20% higher for 1099 — IF you manage expenses and deductions well.`
    },
    {
    ...
    },
    {
      ...
      answer: `1099 ${brand.niche.short}s have access to powerful retirement options: SEP-IRA (contribute up to 25% of net earnings, max $66,000/year in 2024), Solo 401k ($23,000 employee + 25% employer contributions = up to $69,000 total), or Traditional/Roth IRA ($7,000/year). The Solo 401k offers the most flexibility with both employee and employer contribution tiers.`
    },
  ];
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-8 md:mb-12 grid md:grid-cols-2 gap-6">
            <div className="rounded-xl p-6" style={{ backgroundColor: 'var(--bg-secondary)', border: '2px solid #0d9488' }}>
              ...
              <p className="mt-4 text-xs font-medium" style={{ color: 'var(--color-primary)' }}>Best for: Experienced {brand.niche.short}s who want maximum control and income</p>
            </div>
          ...
          <div className="mb-8 md:mb-12">
            <div className="rounded-xl p-6 md:p-8" style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid var(--border-color)' }}>
              ...
              <p className="text-sm mb-4" style={{ color: 'var(--text-secondary)' }}>
                Real-world comparison of a typical {brand.niche.short} earning $160K W2 vs $200K gross as a 1099 contractor:
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            ...
            <Link href="/resources/private-practice-guide" className="block p-4 rounded-lg hover:shadow-sm transition-all" style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid var(--border-color)' }}>
              ...
              <p className="text-sm mt-1" style={{ color: 'var(--text-secondary)' }}>Start your own {brand.niche.short} practice step by step.</p>
            </Link>
