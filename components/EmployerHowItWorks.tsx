...
const STEPS = [
    { img: `${STORAGE_BASE}/storage/v1/object/public/site-assets/images/step-employer-post.webp`, title: 'Post Your Listing', desc: `Start from ${indefinite(brand.niche.short)} template or generate the full description with AI. Set required experience and your post is live in 5 minutes — first one free.` },
